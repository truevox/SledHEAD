// test-uphill-movement.js
// Unit test for UPHILL movement: ensures no glide/inertia and instant stop on key release
// To run: load this script in a test harness or browser console after main game scripts
...
(function() {
  ...
  // Output results
  console.log("[UPHILL TEST] Right move then stop: ", result1 ? "PASS" : "FAIL");
  console.log("[UPHILL TEST] Left move then stop: ", result2 ? "PASS" : "FAIL");
  console.log("[UPHILL TEST] No key, no move: ", result3 ? "PASS" : "FAIL");
